...
import { MUTATION_CHANGE_ACTIVE_ASIGNATURE, MUTATION_CREATE_ASIGNATURE, MUTATION_UPDATE_ASIGNATURE } from '../graphql/Asignature/AsignatureMutations';
import { QUERY_GET_ALL_ASIGNATURE, QUERY_GET_ASIGNATURE } from '../graphql/Asignature/AsignatureQueries';


export const getListAllAsignature = () => {
...
export const changeActiveAsignature = (active: any, id: any) => {
  return async (dispatch: any) => {
    try {
