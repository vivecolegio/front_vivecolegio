...
export const getListAllQuestionTestOnline = (campusId: string) => {
  return async (dispatch: any) => {
    try {
      ...
      await client
        .query({
          query: QUERY_GET_ALL_QUESTION_TEST_ONLINE,
          variables: {
            campusId,
          },
        })
...
export const dataQuestionTestOnline = (id: any) => {
  return async (dispatch: any) => {
    try {
      let data = {};
      await client
        .query({
          query: QUERY_GET_QUESTION_TEST_ONLINE,
          variables: {
            id,
          },
        })
...
export const saveNewQuestionTestOnline = (data: any) => {
  return async (dispatch: any) => {
    try {
      let model: {};
      model = {
      ...
      await client
        .mutate({
          mutation: MUTATION_CREATE_QUESTION_TEST_ONLINE,
...
export const updateQuestionTestOnline = (data: any, id: any) => {
  return async (dispatch: any) => {
    try {
      let model: {};
      model = {
      ...
      await client
        .mutate({
          mutation: MUTATION_UPDATE_QUESTION_TEST_ONLINE,
...
export const changeActiveQuestionTestOnline = (active: any, id: any, showToast: boolean) => {
  return async (dispatch: any) => {
    try {
      let dataChangeActive = null;
      await client
        .mutate({
          mutation: MUTATION_CHANGE_ACTIVE_QUESTION_TEST_ONLINE,
          variables: { id, active },
        })
        .then((dataReponse: any) => {
          if (dataReponse.errors?.length > 0) {
...
export const deleteQuestionTestOnline = (id: any, showToast: boolean) => {
  return async (dispatch: any) => {
    try {
      let dataDelete = null;
      await client
        .mutate({
          mutation: MUTATION_DELETE_QUESTION_TEST_ONLINE,
          variables: { id },
        })
        .then((dataReponse: any) => {
          if (dataReponse.errors?.length > 0) {
...
export const getDropdownsQuestionTestOnline = (campusId: string) => {
  return async (dispatch: any) => {
    try {
      let listData = {};
      await client
        .query({
          query: QUERY_GET_DROPDOWNS_QUESTION_TEST_ONLINE,
          variables: {
            campusId,
          },
        })
