...
import { MUTATION_CHANGE_ACTIVE_ACADEMIC_PERIOD, MUTATION_CREATE_ACADEMIC_PERIOD, MUTATION_UPDATE_ACADEMIC_PERIOD } from '../graphql/AcademicPeriod/AcademicPeriodMutations';
...
export const changeActiveAcademicPeriod = (active: any, id: any) => {
  return async (dispatch: any) => {
    try {
