...
import { MUTATION_CHANGE_ACTIVE_AREA, MUTATION_CREATE_AREA, MUTATION_UPDATE_AREA } from '../graphql/Area/AreaMutations';
import { QUERY_GET_ALL_AREA, QUERY_GET_AREA } from '../graphql/Area/AreaQueries';


export const getListAllArea = () => {
...
export const changeActiveArea = (active: any, id: any) => {
  return async (dispatch: any) => {
    try {
