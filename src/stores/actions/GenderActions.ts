...
export const getListAllGender = () => {
  return async (dispatch: any) => {
    try {
      let listData = {};
      await client
        .query({
          query: QUERY_GET_ALL_GENDER,
        })
        .then((result: any) => {
...
export const dataGender = (id: any) => {
  return async (dispatch: any) => {
    try {
      let data = {};
      await client
        .query({
          query: QUERY_GET_GENDER,
          variables: {
            id,
          },
        })
...
export const saveNewGender = (data: any) => {
  return async (dispatch: any) => {
    try {
      let model: {};
      model = {
      ...
      await client
        .mutate({
          mutation: MUTATION_CREATE_GENDER,
...
export const updateGender = (data: any, id: any) => {
  return async (dispatch: any) => {
    try {
      let model: {};
      model = {
      ...
      await client
        .mutate({
          mutation: MUTATION_UPDATE_GENDER,
...
export const changeActiveGender = (active: any, id: any, showToast: boolean) => {
  return async (dispatch: any) => {
    try {
      ...
      await client
        .mutate({
          mutation: MUTATION_CHANGE_ACTIVE_GENDER,
          variables: { id, active },
        })
        .then((dataReponse: any) => {
          if (dataReponse.errors?.length > 0) {
