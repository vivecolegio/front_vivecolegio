...
export const dataExperienceLearningSelfAssessmentValuation = (id: any) => {
  return async (dispatch: any) => {
    try {
      let data = {};
      await client
        .query({
          query: QUERY_GET_EXPERIENCE_LEARNING_SELF_ASSESSMENT_VALUATION,
          variables: {
            id,
          },
        })
...
export const saveNewExperienceLearningSelfAssessmentValuation = (data: any, showToast: boolean) => {
  return async (dispatch: any) => {
    try {
      let model: any = {};
      model = {
      ...
      await client
        .mutate({
          mutation: MUTATION_CREATE_EXPERIENCE_LEARNING_SELF_ASSESSMENT_VALUATION,
...
export const updateExperienceLearningSelfAssessmentValuation = (data: any, id: any, showToast: boolean) => {
  return async (dispatch: any) => {
    try {
      let model: any = {};
      model = {
      ...
      await client
        .mutate({
          mutation: MUTATION_UPDATE_EXPERIENCE_LEARNING_SELF_ASSESSMENT_VALUATION,
...
export const changeActiveExperienceLearningSelfAssessmentValuation = (active: any, id: any, showToast: boolean) => {
  return async (dispatch: any) => {
    try {
      let dataChangeActive = null;
      await client
        .mutate({
          mutation: MUTATION_CHANGE_ACTIVE_EXPERIENCE_LEARNING_SELF_ASSESSMENT_VALUATION,
          variables: { id, active },
        })
        .then((dataReponse: any) => {
          if (dataReponse.errors?.length > 0) {
...
export const deleteExperienceLearningSelfAssessmentValuation = (id: any, showToast: boolean) => {
  return async (dispatch: any) => {
    try {
      let dataDelete = null;
      await client
        .mutate({
          mutation: MUTATION_DELETE_EXPERIENCE_LEARNING_SELF_ASSESSMENT_VALUATION,
          variables: { id },
        })
        .then((dataReponse: any) => {
          if (dataReponse.errors?.length > 0) {
