...
import { MUTATION_CHANGE_ACTIVE_EDUCATION_LEVEL, MUTATION_CREATE_EDUCATION_LEVEL, MUTATION_UPDATE_EDUCATION_LEVEL} from '../graphql/EducationLevel/EducationLevelMutations';
