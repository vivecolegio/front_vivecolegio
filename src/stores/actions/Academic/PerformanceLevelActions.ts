...
import { MUTATION_CHANGE_ACTIVE_PERFORMANCE_LEVEL, MUTATION_CREATE_PERFORMANCE_LEVEL, MUTATION_UPDATE_PERFORMANCE_LEVEL } from '../../graphql/Academic/PerformanceLevel/PerformanceLevelMutations';
import { QUERY_GET_ALL_PERFORMANCE_LEVEL, QUERY_GET_PERFORMANCE_LEVEL } from '../../graphql/Academic/PerformanceLevel/PerformanceLevelQueries';
...
export const changeActivePerformanceLevel = (active: any, id: any) => {
  return async (dispatch: any) => {
    try {
