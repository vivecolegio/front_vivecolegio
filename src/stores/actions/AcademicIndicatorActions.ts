...
import { MUTATION_CHANGE_ACTIVE_ACADEMIC_INDICATOR, MUTATION_CREATE_ACADEMIC_INDICATOR, MUTATION_UPDATE_ACADEMIC_INDICATOR } from '../graphql/AcademicIndicator/AcademicIndicatorMutations';
...
export const changeActiveAcademicIndicator = (active: any, id: any) => {
  return async (dispatch: any) => {
    try {
