...
import { MUTATION_CHANGE_ACTIVE_STANDARD, MUTATION_CREATE_STANDARD, MUTATION_UPDATE_STANDARD } from '../graphql/Standard/StandardMutations';
import { QUERY_GET_ALL_STANDARD, QUERY_GET_STANDARD } from '../graphql/Standard/StandardQueries';


export const getListAllStandard = () => {
...
export const changeActiveStandard = (active: any, id: any) => {
  return async (dispatch: any) => {
    try {
