...
const ForumCourseList = (props: any) => {
  ...
  const additionalFunction = async (item: any, btn: any) => {
    switch (btn?.action) {
      case 'goToChildrenCourseAssignment':
        goToChildren(`/forumAcademicAsignatureCourseList?courseId=${item.id}&courseName=${item.name}`);
        break;
      default:
        break;
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(ForumCourseList);
