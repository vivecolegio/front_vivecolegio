...
const ReportSpreadsheetAccumulatedAverageCourseCourseList = (props: any) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(ReportSpreadsheetAccumulatedAverageCourseCourseList);
