...
const ReportSpreadsheetAccumulatedBehaviourCourseList = (props: any) => {
  ...
  const additionalFunction = async (item: any, btn: any) => {
    switch (btn?.action) {
      case 'goToChildrenSpredsheetCourse':
        goToChildren(
          `/spreadsheetAccumulatedBehaviour?courseId=${item.id}`,
        );
        break;
      default:
        break;
...
export default connect(mapStateToProps, mapDispatchToProps)(ReportSpreadsheetAccumulatedBehaviourCourseList);
