          ...
          <ModalBody>
            ...
            <div className="form-group">
              ...
              <Select
                ...
                {...methods.register('modalityId', { required: true })}
                className="react-select"
                classNamePrefix="react-select"
                options={modalityList}
                value={modality}
                onChange={(selectedOption) => {
                  methods.setValue('modalityId', selectedOption?.key);
...
const mapDispatchToProps = { ...specialityActions, ...schoolActions, ...modalityActions };
