...
const ReportSpreadsheetAccumulatedCourseCourseList = (props: any) => {
  ...
  const additionalFunction = async (item: any, btn: any) => {
    switch (btn?.action) {
      ...
      case 'goToChildrenSpredsheetAverageCourse':
        ...
        break;
      case 'goToChildrenSpredsheetBehaviour':
        goToChildren(
          `/spreadsheetBehaviour?courseId=${item.id}`,
        );
        break;
      default:
        break;
        ...
        <>
          ...
          <DataList
            ...
            childrenButtons={[
              ...
              {
                id: 2,
                label: 'Planilla Comportamiento',
                color: 'secondary',
                icon: 'iconsminds-gear',
                action: 'goToChildrenSpredsheetBehaviour',
              }
            ]}
            withChildren={true}
...
export default connect(mapStateToProps, mapDispatchToProps)(ReportSpreadsheetAccumulatedCourseCourseList);
