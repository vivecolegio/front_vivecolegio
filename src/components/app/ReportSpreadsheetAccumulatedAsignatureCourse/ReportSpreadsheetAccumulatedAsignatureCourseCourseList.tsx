...
const ReportSpreadsheetAccumulatedAsignatureCourseCourseList = (props: any) => {
  ...
  const additionalFunction = async (item: any, btn: any) => {
    switch (btn?.action) {
      case 'goToChildrenSpredsheetCourse':
        goToChildren(
          `/spreadsheetAccumulatedAsignatureCourse?courseId=${item.id}`,
        );
        break;
      default:
        break;
...
export default connect(mapStateToProps, mapDispatchToProps)(ReportSpreadsheetAccumulatedAsignatureCourseCourseList);
