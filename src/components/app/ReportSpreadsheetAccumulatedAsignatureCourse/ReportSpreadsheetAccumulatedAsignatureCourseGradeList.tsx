...
const ReportSpreadsheetAccumulatedAsignatureCourseGradeList = (props: any) => {
  ...
  const additionalFunction = async (item: any, btn: any) => {
    switch (btn?.action) {
      case 'goToChildrenCourse':
        goToChildren(`/reportSpreadsheetAccumulatedAsignatureCourseCourseList?academicGradeId=${item?.id}&gradeName=${item?.name}`);
        break;
      default:
        break;
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(ReportSpreadsheetAccumulatedAsignatureCourseGradeList);
