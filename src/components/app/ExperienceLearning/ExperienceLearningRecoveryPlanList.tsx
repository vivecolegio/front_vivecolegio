...
const ExperienceLearningRecoveryPlanList = (props: any) => {
      ...
      {dataTable !== null ? (
        <>
          ...
          <ExperienceLearningCreateEdit
            experienceLearningType={"RECOVERY"}
            data={data}
            isLg={true}
            modalOpen={modalOpen}
            toggleModal={() => {
...
export default connect(mapStateToProps, mapDispatchToProps)(ExperienceLearningRecoveryPlanList);
