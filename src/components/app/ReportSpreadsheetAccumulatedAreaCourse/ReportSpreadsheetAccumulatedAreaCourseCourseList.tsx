...
const ReportSpreadsheetAccumulatedAreaCourseCourseList = (props: any) => {
  ...
  const additionalFunction = async (item: any, btn: any) => {
    switch (btn?.action) {
      case 'goToChildrenSpredsheetCourse':
        goToChildren(
          `/spreadsheetAccumulatedAreaCourse?courseId=${item.id}`,
        );
        break;
      default:
        break;
...
export default connect(mapStateToProps, mapDispatchToProps)(ReportSpreadsheetAccumulatedAreaCourseCourseList);
